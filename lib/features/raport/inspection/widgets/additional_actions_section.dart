...
import 'package:apiarium/features/raport/inspection/widgets/fields/additional_actions_field.dart';
import 'package:apiarium/features/raport/widgets/expandable_section.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class AdditionalActionsSection extends StatelessWidget {
  const AdditionalActionsSection({super.key});

  static const List<String> fields = ['actions.additional'];

  @override
  Widget build(BuildContext context) {
    final isExpanded = context.select<InspectionBloc, bool>(
      (bloc) => bloc.state.expandedSections['additionalActionsSection'] ?? false,
    );
    ...
    return ExpandableSection(
      ...
      onToggle: () => context.read<InspectionBloc>().add(
        const ToggleSectionEvent('additionalActionsSection'),
      ),
      children: const [

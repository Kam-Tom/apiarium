...
class ImprovedQueenBreedCard extends StatelessWidget {
  ...
  Widget _buildDetailedInfo() {
    ...
    if (breed.origin != null && breed.origin!.isNotEmpty) {
      infoChips.add(_buildInfoChip(Icons.public, breed.origin!, Colors.green));
    } else if (breed.country != null && breed.country!.isNotEmpty) {
      infoChips.add(_buildInfoChip(Icons.flag, breed.country!, Colors.blue));
    }
    ...
    // Cost
    if (breed.cost != null) {
      infoChips.add(_buildInfoChip(Icons.attach_money, '\$${breed.cost!.toStringAsFixed(0)}', Colors.purple));
    }

    // Best rating display
    final ratings = [
      if (breed.temperamentRating != null && breed.temperamentRating! > 0) ('Temperament', breed.temperamentRating!, Colors.blue),
      if (breed.honeyProductionRating != null && breed.honeyProductionRating! > 0) ('Honey', breed.honeyProductionRating!, Colors.amber),
      if (breed.winterHardinessRating != null && breed.winterHardinessRating! > 0) ('Winter', breed.winterHardinessRating!, Colors.cyan),
      if (breed.diseaseResistanceRating != null && breed.diseaseResistanceRating! > 0) ('Disease Resist.', breed.diseaseResistanceRating!, Colors.red),
      if (breed.popularityRating != null && breed.popularityRating! > 0) ('Popularity', breed.popularityRating!, Colors.pink),
    ];

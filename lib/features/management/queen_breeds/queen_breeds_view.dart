...
import 'package:apiarium/features/management/queen_breeds/widgets/improved_queen_breed_card.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                if (_hasActiveFilters(state)) ...[
                  ...
                  ElevatedButton(
                    onPressed: () {
                      context.read<QueenBreedsBloc>().add(const FilterBreedsByStarred(null));
                      context.read<QueenBreedsBloc>().add(const FilterBreedsByLocal(null));
                    },

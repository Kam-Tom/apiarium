...
import 'package:apiarium/features/management/edit_apiary/widgets/apiary_location_map.dart';
  ...
  Widget _buildLocationField() {
    final locationError = context.select(
      (EditApiaryBloc bloc) =>
          bloc.state.showValidationErrors && bloc.state.location.trim().isEmpty
              ? 'edit_apiary.location_required'.tr()
              : null,
    );
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        labelText: 'edit_apiary.location_address'.tr(),
        border: const OutlineInputBorder(),
        hintText: 'edit_apiary.location_hint'.tr(),
        ...
        suffixIcon: IconButton(
          ...
          tooltip: _showMap ? 'edit_apiary.hide_map'.tr() : 'edit_apiary.show_map'.tr(),
        ),
      ),
      onChanged: (value) {

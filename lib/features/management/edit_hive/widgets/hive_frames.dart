...
class _HiveFramesState extends State<HiveFrames> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<EditHiveBloc, EditHiveState>(
      ...
      builder: (context, state) {
        ...
        _frameCountController.text = state.honeyFrameCount.toString();
        _broodFrameCountController.text = state.broodFrameCount.toString();
        _broodBoxCountController.text = state.boxCount.toString();
        _honeySuperBoxCountController.text = state.superBoxCount.toString();
  ...
  Widget _buildFramesAndBoxesGrid(BuildContext context, EditHiveState state, bool isSmall) {
    final broodBoxCount = state.boxCount;
    final honeySuperCount = state.superBoxCount;
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                helperText: framesPerBox > 0 && honeySuperCount > 0
                    ? '${state.honeyFrameCount}/${framesPerBox * honeySuperCount}'
                    : 'total_frames'.tr(),
                suffixIcon: _buildCounterButtons(
                  onDecrease: () {
                    final currentValue = state.honeyFrameCount;
                    if (currentValue > 0) {
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                helperText: framesPerBox > 0 && broodBoxCount > 0
                    ? '${state.broodFrameCount}/${framesPerBox * broodBoxCount}'
                    : 'frames_with_brood'.tr(),
                suffixIcon: _buildCounterButtons(
                  onDecrease: () {
                    final currentValue = state.broodFrameCount;
                    if (currentValue > 0) {
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                helperText: honeySuperCount > 0 && framesPerBox > 0
                    ? '${honeySuperCount * framesPerBox} ${'edit_hive.frames_capacity'.tr()}'
                    : 'frames_with_honey'.tr(),
                suffixIcon: _buildCounterButtons(
                  onDecrease: () {
                    final currentBoxValue = state.superBoxCount;
                  ...
                  onLongPressIncrease: () {
                    final currentValue = state.superBoxCount;
                    _startContinuousUpdate(
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: _buildCounterButtons(
                  onDecrease: () {
                    final currentValue = state.boxCount;
                    if (currentValue > 0) {
  ...
  void _adjustFrameCountForHoneyBoxChange({
    ...
    final oldBoxCount = state.superBoxCount;
    final oldFrameCount = state.honeyFrameCount;
  ...
  void _adjustBroodFrameCountForBroodBoxChange({
    ...
    final framesPerBox = state.framesPerBox ?? 0;
    if (framesPerBox == 0) return;
    final oldBoxCount = state.boxCount;
    final oldBroodFrameCount = state.broodFrameCount;
    final newMaxFrames = newBoxCount * framesPerBox;

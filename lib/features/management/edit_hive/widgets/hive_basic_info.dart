    ...
    return Column(
      ...
      children: [
        ...
        SearchableRoundedDropdown<HiveType>(
          ...
          items: availableHiveTypes,
          minHeight: 56,
          hintText: 'edit_hive.hive_type_hint'.tr(),
          searchHintText: 'edit_hive.hive_type_search_hint'.tr(),
          onChanged: (value) {
            if (value != null) {
          ...
          searchMatchFn: (item, searchValue) {
            ...
            return hiveType.name.toLowerCase().contains(lowerSearch) ||
                   ...
                   (hiveType.country?.toLowerCase().contains(lowerSearch) ?? false);
          },

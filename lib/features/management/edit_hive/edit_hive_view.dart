...
import 'package:apiarium/features/management/edit_hive/widgets/hive_accessories.dart';
import 'package:apiarium/features/management/edit_hive/widgets/hive_basic_info.dart';
import 'package:apiarium/features/management/edit_hive/widgets/hive_location.dart';
import 'package:apiarium/features/management/edit_hive/widgets/hive_queen.dart';
    ...
    if (state.formStatus == EditHiveStatus.success) {
      ...
      if (state.savedHive != null && isCreation) {
        ...
        await showAddSpendingDialog(
          ...
          group: 'management',
          item: 'hive',
          variant: state.hiveType?.name,
          initialDate: DateTime.now(),
          apiaries: apiaries,
          initialApiary: state.selectedApiary,
          notes: '${'common.hive'.tr()} : ${state.savedHive!.name}',
          cost: state.hiveCost,
        );

...
class EditHiveTypeBloc extends Bloc<EditHiveTypeEvent, EditHiveTypeState> {
  ...
  EditHiveTypeBloc({
    ...
    on<EditHiveTypeAccessoriesChanged>(_onAccessoriesChanged);
      ...
      if (event.hiveTypeId != null) {
        ...
        if (hiveType != null) {
          ...
          emit(state.copyWith(
            ...
            accessories: () => HiveAccessoryHelper.stringListToAccessories(hiveType.accessories),
            country: () => hiveType.country,
            isLocal: () => hiveType.isLocal,
            isStarred: () => hiveType.isStarred,
            cost: () => hiveType.cost,
            imageName: () => imagePath,
            iconType: () => hiveType.iconType,
          ));
        } else {
          emit(state.copyWith(
  ...
  void _onIconChanged(EditHiveTypeIconChanged event, Emitter<EditHiveTypeState> emit) {
    emit(state.copyWith(iconType: () => event.iconType));
  }
  ...
  void _onAccessoriesChanged(EditHiveTypeAccessoriesChanged event, Emitter<EditHiveTypeState> emit) {

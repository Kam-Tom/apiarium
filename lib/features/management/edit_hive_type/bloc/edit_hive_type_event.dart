...
class EditHiveTypeIconChanged extends EditHiveTypeEvent {
  ...
  const EditHiveTypeIconChanged(this.iconType);

  @override
  List<Object?> get props => [iconType];
}
...
class EditHiveTypeAccessoriesChanged extends EditHiveTypeEvent {
  final List<HiveAccessory> accessories;

  const EditHiveTypeAccessoriesChanged(this.accessories);

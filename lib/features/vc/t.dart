...
const modelAsset = 'assets/models/vosk-model-small-pl-0.22.zip';

class VCPage extends StatefulWidget {
  const VCPage({Key? key}) : super(key: key);

  @override
  State<VCPage> createState() => _TestScreenState();
}

class _TestScreenState extends State<VCPage> {
  ...
  void _modelCreate() async {
    ...
    _toastFutureError(_vosk
        .createModel(await ModelLoader().loadFromNetwork('https://alphacephei.com/vosk/models/vosk-model-small-pl-0.22.zip'))
